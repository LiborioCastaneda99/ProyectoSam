...
$sql="SELECT `ID_Categoria`, Categorias.Categoria FROM `Tipo_de_servicio`,Categorias WHERE Tipo_de_servicio.ID_Categoria=Categorias.ID group by Categorias.Categoria";
...
<head>
  ...
  <title>Control de datos Servicios | PROYECTO 3 CORTE</title>
  ...
  <script src="modelo/funcionesServ.js"></script>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
   <div class="modal-content">
     <div class="modal-header">
      <h5 class="modal-title text-center">Agregar Tipo de servicio</h5>
     ...
     <form class="form p-2 mt-2">
      <div class="form-group text-left">
        <div class="col">
          ...
          <select class="form form-control" id="nombreCategoria" required="">
            <?php 
      ...
      <div class="form-group text-left">
        <div class="col">
          ...
          <input type="text" id="nombreServicio" class="form form-control" required="">
        </div>
      </div>
    </form>
  </div>
       ...
       <form class="form p-2 mt-2">
        <div class="form-group text-left row">
          <div class="col">
            ...
            <input type="text" id="nombreServiciou" class="form form-control">
            <input type="hidden" id="idServicio" class="form form-control">
          </div>
        </div>
      </form>
    </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#guardarnuevo').click(function(){
      ...
      agregardatos(nombreCategoria,nombreServicio);
    });
